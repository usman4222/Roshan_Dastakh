...
const NavBar = ({ userData }) => {
    ...
    return <div>
        <div className="">
            <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none px-4 py-2 xl:px-16 lg:px-8 lg:py-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-x-3">
                            ...
                            {userData && userData.photo && (
                                        <Link to={'profile'}><img src={userData.photo} className="w-8 h-8 rounded-full" alt="" /></Link>
                                )}
                            {/* <Menu>
                                {userData && userData.photo && (
                                    <MenuHandler>
